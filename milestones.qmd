...
For each milestone, each group is supposed to prepare **1 slide** (singular!) and **upload them on Ilias until the deadline (10:00 Monday before the respective session).** See the milestone page on Ilias for a template slide.
...
The analysis you propose here along with the feedback you receive will guide your further work on the project (beyond answering your main research question) between milestone 5 and the time of handing in your project. 
