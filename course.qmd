...
## Exercises
The homeworks are voluntary, but **HIGHLY** recommended. The semester project is based on the exercises. If you went through them and understood the content, the semester project will be easier to tackle.
...
## Workbench sessions
During the slot on Friday (09:45 AM), tutors will be present to provide additional support on the course and project work. On days when no specific presentations are planned, you can still attend and get feedback or use the space to e.g. work on your project.
...
- This is the fifth iteration of the course and the material improves every time.
- The other course ("Übung") will not be made available.
- This semester's "Discussions" will be in Hybrid-Mode.