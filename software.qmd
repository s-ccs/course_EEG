...
It might be helpful as a manual to get an overview what should be there and what shouldn't.

## mne-python

MNE Python is a general EEG processing, analysis and visualization toolbox. It will suffice for 99% of your EEG analyses.
...
## IClabel
A tool to automatically classify artefactual independent components is ICLabel. You can use it here: https://github.com/mne-tools/mne-icalabel or via `mne-bids-pipeline`
