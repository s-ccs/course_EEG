...
How I will grade the projects can be seen in [grading](grading.qmd). I value line of thinking and documented motivation much higher than actual results. I want to see that you understand what you are doing.
...
|------------------|------------------|------------------|------------------|
| 20       | grating            | decoding | [dataset](https://openneuro.org/datasets/ds004043/versions/1.1.0), [paper](https://www.biorxiv.org/content/10.1101/2021.05.24.445376v1)    |
| 19       | reaching           | ERP      | [dataset](https://openneuro.org/datasets/ds003846/versions/1.0.1), [paper](https://doi.org/10.1145/3290605.3300657)    |
| 24       | pattern symmetry   | ERP      | [dataset](https://nemar.org/dataexplorer/detail?dataset_id=ds004347), [paper](https://doi.org/10.1016/j.neuropsychologia.2012.10.003) |
| 12       | reward             | ERP      | [dataset](https://nemar.org/dataexplorer/detail?dataset_id=ds004147), [paper](https://doi.org/10.1016/j.neuroimage.2022.119456) |
| 18       | walking oddball     | ERP      | [dataset](https://nemar.org/dataexplorer/detail?dataset_id=ds004033), [paper1](https://doi.org/10.1016/j.neuroimage.2022.119099), [paper2](https://doi.org/10.1016/j.dib.2022.108847) |
| 47       | social task        | timefreq | [dataset](https://nemar.org/dataexplorer/detail?dataset_id=ds003702), [paper](https://doi.org/10.1093/scan/nsab123) |
| 17       | game-playing       | ERP      | [dataset](https://nemar.org/dataexplorer/detail?dataset_id=ds003517), [paper](https://doi.org/10.1016/j.neuroimage.2016.02.075) |
| 31       | visual stimulation | ERP      | [dataset](https://openneuro.org/datasets/ds006547/versions/1.0.0), [paper](https://doi.org/10.1101/2025.08.09.669461)    |
| 48       | vr visual tasks    | ERP      | [dataset](https://openneuro.org/datasets/ds005841/versions/1.0.0), [paper](https://doi.org/10.1016/j.cortex.2025.05.008)    |
| 62       | competitive decision-making    | decoding      | [dataset](https://openneuro.org/datasets/ds006761/versions/1.0.0), [paper](https://www.biorxiv.org/content/10.1101/2025.01.09.632285v3)    |
...
A list of the typical steps you will perform: 
...
-   Please work modularly! Don't put all your functions in a single jupyter-notebook. Please use notebooks for your analysis & organise your functions into ./src/xyz.py files.
...
You can share a git of your project and a report, or the code and the report via Ilias. The git can be on github or on the university gitlab. The report can be a jupyter notebook if you prefer to intermingle code and documentation. 

A possible structure for your report might include: an introduction; an overview of the original paper and analysis; details of your replication; and a discussion of your results. The Workbench slides uploaded on Ilias discuss this structure more in depth.

The report is there to document your decisions and thoughts along the pipeline. I am especially interested why you chose certain steps / parameters / analyses / visualizations. Make grading easy for me and show that you understood what you are doing and what your results are.
...
Please hand in the documents until 31.03.2026.
