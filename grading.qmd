...
Generally, you see that **documentation and explanations** are important. I do not (only) want to see that you analyzed the dataset, but I want to see what your motivation for choosing parameters is (parameters like reference, filter settings, data removal criteria, algorithmic choices etc.).
